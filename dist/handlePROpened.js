...
async function handlePROpened(slackToken, slackChannel, githubToken, initialMessageTemplate, githubToSlackMapJSON) {
    ...
    core.info(`Slack request body: ${JSON.stringify(slackRequestBody)}`);
    await fetch('https://slack.com/api/chat.postMessage', {
        ...
        body: JSON.stringify(slackRequestBody),
    });
}
